...
(function(){
  ...
  // Extract the data
  const cleanData = extractClientData();
  ...
  alert(`✅ Session data extracted successfully!\n\n📝 Name: ${cleanData.name || 'Not found'}\n📞 Phone: ${cleanData.phone || 'Not found'}\n📧 Email: ${cleanData.email || 'Not found'}\n📸 Session: ${cleanData.sessionTitle || 'Not found'}\n⏰ Time: ${cleanData.sessionTime || 'Not found'}\n\nThe Session Reminder form is now open in a new tab.`);
})();