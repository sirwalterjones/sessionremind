      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-20">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a
              href="/new"
              className="inline-flex items-center px-8 py-4 bg-rose-400 text-white font-medium rounded-full hover:bg-rose-500 transition-all duration-200 shadow-sm hover:shadow-md transform hover:-translate-y-0.5 text-lg"
            >
            ...
            <a
              href="/dashboard"
              className="inline-flex items-center px-8 py-4 bg-white border border-gray-200 text-gray-700 font-medium rounded-full hover:bg-gray-50 hover:border-gray-300 transition-all duration-200 shadow-sm text-lg"
            >
              <span className="mr-3">📊</span>
              View Dashboard
            </a>
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-16">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            ...
            <div className="bg-green-50 border border-green-100 rounded-2xl p-6 mb-6">
              <h4 className="text-green-800 font-medium mb-3">✨ Best User Experience</h4>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <a 
                  href="/extension"
                  className="inline-flex items-center justify-center px-6 py-3 bg-green-500 text-white font-medium rounded-full hover:bg-green-600 transition-all duration-200"
...
✅ Chrome, Edge, Brave, and other Chromium browsers`;
                  ...
                  className="inline-flex items-center justify-center px-6 py-3 bg-white border border-gray-200 text-gray-700 font-medium rounded-full hover:bg-gray-50 transition-all duration-200"
                >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="text-center p-3 bg-gray-50 rounded-xl">
                <div className="w-8 h-8 bg-green-500 text-white rounded-full flex items-center justify-center mx-auto mb-2 font-bold text-sm">1</div>
                <p className="text-xs text-gray-600">Download</p>
              </div>
              <div className="text-center p-3 bg-gray-50 rounded-xl">
                <div className="w-8 h-8 bg-blue-500 text-white rounded-full flex items-center justify-center mx-auto mb-2 font-bold text-sm">2</div>
                <p className="text-xs text-gray-600">Install</p>
              </div>
              <div className="text-center p-3 bg-gray-50 rounded-xl">
                <div className="w-8 h-8 bg-purple-500 text-white rounded-full flex items-center justify-center mx-auto mb-2 font-bold text-sm">3</div>
                <p className="text-xs text-gray-600">Visit UseSession</p>
              </div>
              <div className="text-center p-3 bg-gray-50 rounded-xl">
                <div className="w-8 h-8 bg-orange-500 text-white rounded-full flex items-center justify-center mx-auto mb-2 font-bold text-sm">4</div>
                <p className="text-xs text-gray-600">Click Button</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            ...
            <div className="bg-blue-50 border border-blue-100 rounded-2xl p-6 mb-6">
              <h4 className="text-blue-800 font-medium mb-3">🔗 Quick Start</h4>
              ...
              <div className="text-center">
                <a 
                  ...
                  className="inline-flex items-center px-6 py-3 bg-blue-500 text-white font-medium rounded-full hover:bg-blue-600 transition-all duration-200 cursor-move"
            ...
            <div className="grid grid-cols-3 gap-4 mb-6">
              <div className="text-center p-3 bg-gray-50 rounded-xl">
                <div className="w-8 h-8 bg-green-500 text-white rounded-full flex items-center justify-center mx-auto mb-2 font-bold text-sm">1</div>
                <p className="text-xs text-gray-600">Drag to Bookmarks</p>
              </div>
              <div className="text-center p-3 bg-gray-50 rounded-xl">
                <div className="w-8 h-8 bg-blue-500 text-white rounded-full flex items-center justify-center mx-auto mb-2 font-bold text-sm">2</div>
                <p className="text-xs text-gray-600">Visit UseSession</p>
              ...
              <div className="text-center p-3 bg-gray-50 rounded-xl">
                <div className="w-8 h-8 bg-purple-500 text-white rounded-full flex items-center justify-center mx-auto mb-2 font-bold text-sm">3</div>
                <p className="text-xs text-gray-600">Click & Done!</p>
              </div>
            </div>
            ...
            <div className="bg-amber-50 border border-amber-100 rounded-xl p-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-amber-800 font-medium text-sm mb-1">Show bookmarks bar:</p>
                  <p className="text-amber-700 text-xs">
                    <kbd className="px-2 py-1 bg-amber-200 rounded text-xs font-mono">Ctrl+Shift+B</kbd> (Windows) or 
