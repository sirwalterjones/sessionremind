  ...
  if (loading) {
    return (
      <div className="animate-pulse space-y-4">
        ...
        <div className="h-10 w-1/3 rounded bg-ink/10" />
    ...
    return (
      <div className="flex min-h-[60vh] items-center justify-center text-ink">
        <div className="w-full max-w-sm rounded-2xl border border-hairline bg-card p-10 text-center">
          ...
          <a
            href="/login"
            className="mt-6 inline-block rounded-full bg-accent px-5 py-2.5 font-semibold text-accent-ink transition-shadow hover:shadow-glow"
          >
            Go to login
          </a>
        </div>
